...
parser.add_argument("--tvs", default=1.0, type=float, help = "Coeff. of spatial TV")
parser.add_argument("--tvt", default=1.0, type=float, help = "Coeff. of temporal TV")



opt = parser.parse_args()
print('Doing for tvs : {} and tvt : {}'.format(opt.tvs, opt.tvt))
...
filename = '{}/movie_{}_{}'.format(folder, int(opt.tvs*10**3), int(opt.tvt*10**3))
